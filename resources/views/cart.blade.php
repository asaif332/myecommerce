                              ...
                              @foreach(Cart :: content() as $product)
                                <tr class="cart_item">
                                    ...
                                    <td class="product-remove">
                                        <a href="{{route('cart.delete' , ['rowId' => $product->rowId])}}" class="product-del remove" title="Remove this item">
                                    ...
                                    <td class="product-thumbnail">
                                        ...
                                        <div class="cart-product__item">
                                            <a href="#">
                                                <img src="{{asset($product->model->image)}}" alt="product" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" style="width:60px;height:60px;">
                                            </a>
                                    ...
                                    <td class="product-quantity">
                                        ...
                                        <div class="quantity">
                                            <a href="{{route('cart.decr' , ['rowId' => $product->rowId , 'qty' => $product->qty])}}" class="quantity-minus">-</a>
                                            <input title="Qty" class="email input-text qty text" type="text" value="{{$product->qty}}" readonly>
                                            <a href="{{route('cart.incr' , ['rowId' => $product->rowId , 'qty' => $product->qty])}}" class="quantity-plus">+</a>
                                        </div>
